...
(function() {
  ...
  getDefaultNetworkByInet4 = function(callback) {
    return getDefaultNetwork("netstat -rn -f inet | awk '$3~/UG/ {print $2,$6;}'", function(error, data) {
      return callback(error, data);
    });
  };

  getDefaultNetworkByInet6 = function(callback) {
    return getDefaultNetwork("netstat -rn -f inet6 | awk '$3~/UG/ {print $2,$4;}'", function(error, data) {
      return callback(error, data);
    });
  };
